...
![](https://chart.googleapis.com/chart?cht=tx&chl=F_0=0)
...
キューにもスタックと同様に push と pop という操作があり、push では一番失後ろにデータを追加する操作、pop では一番最初のデータを取り出す操作である。
...
<img src="https://chart.googleapis.com/chart?cht=Ax=b">
と書くことができる。
この行列<img src="https://chart.googleapis.com/chart?cht=A">に対して行変形を適用することで単位行列にすることができれば、同じ手順を<img src="https://chart.googleapis.com/chart?cht=b">へと適用することで解を得ることができる。
